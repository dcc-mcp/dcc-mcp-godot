...
the [official installation guide](https://github.com/dcc-mcp/dcc-mcp-agent-plugins#install). Start Godot,
...
The list must include `dcc_type=godot`. If it does not, follow the
